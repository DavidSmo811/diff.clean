...
class reconstruction_loop:
    def __init__(self, data_loader, unet, optimizer,num_max_major_cycle, pix_size=512, fov_arcsec=6000, eps=1e-6, max_resmean=1e-3):
    ...
    def minor_cycle_step(self, residual_image, sky_image):
    ...
    def major_cycle_step(self, data_in):
        ...
        prediction_image = self.minor_cycle_step(residual_image, y)
